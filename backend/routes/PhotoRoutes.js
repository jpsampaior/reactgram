...
// Controller
const { insertPhoto, deletePhoto, getAllPhotos, getPhotoByUserId, getPhotoById, updatePhoto, likePhoto, commentPhoto, searchPhoto } = require('../controllers/PhotoController');
...
router.get('/user/:id', authGuard, getPhotoByUserId)
